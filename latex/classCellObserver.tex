...
\item 
\hyperlink{classCellObserver_a5789d1039a4d96afacae64a9a1cb90a5}{operator T} () const 
\item 
...
\index{Cell\+Observer@{Cell\+Observer}!operator T@{operator T}}
\index{operator T@{operator T}!Cell\+Observer@{Cell\+Observer}}
\subsubsection[{\texorpdfstring{operator T() const }{operator T() const }}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , T Default\+Value$>$ {\bf Cell\+Observer}$<$ T, Default\+Value $>$\+::operator T (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hypertarget{classCellObserver_a5789d1039a4d96afacae64a9a1cb90a5}{}\label{classCellObserver_a5789d1039a4d96afacae64a9a1cb90a5}
Return T value when it is in the right hand side position. \index{Cell\+Observer@{Cell\+Observer}!operator=@{operator=}}
